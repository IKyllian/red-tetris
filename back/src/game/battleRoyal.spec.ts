...
describe('battleRoyal', () => {
    ...
    describe('getPlayerGame', () => {
        it('should return the correct player game', () => {
            expect(battleRoyal.getPlayerGame('player2')).toEqual(battleRoyal.games[1])
        })
    ...
    describe('start', () => {
        it('should start the game', () => {
            const updateSpy = jest.spyOn(battleRoyal as any, 'update').mockImplementation(() => {});
            battleRoyal.start();
    ...
    describe('handleIndestructibleLine', () => {
        it('should give the correct number of indestructible lines to other players', () => {
            ...
            expect(server.to).toHaveBeenCalledWith(battleRoyal.games[0].player.id)
            expect(server.emit).toHaveBeenCalledWith(SocketEvent.IndestructibleLine, indestructiblePacket)
    ...
    describe('checkGameOver', () => {
        it('should return true when the game is over', () => {
            ...
            expect(server.emit).toHaveBeenCalledWith(SocketEvent.GameOver, battleRoyal['ranking'])
        })
